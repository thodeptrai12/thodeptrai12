...
public class Search_Item extends javax.swing.JPanel {
    ...
    private void setData(DataSearch data) {
        ...
        if (data.isStory()) {
            ...
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/time.png")));
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/search_small.png"))); // NOI18N
